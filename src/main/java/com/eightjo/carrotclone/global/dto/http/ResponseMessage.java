...
public class ResponseMessage {
    ...
    public static final String ALREADY_ENROLLED_NICKNAME = "이미 가입한 닉넨임입니다.";
    ...
    public static final String BOARD_LIKE_CREATE = "게시판 찜 하기 성공";

    public static final String BOARD_LIKE_DELETE = "게시판 찜 해제 성공";
